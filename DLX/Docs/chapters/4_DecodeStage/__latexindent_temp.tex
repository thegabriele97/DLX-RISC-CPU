...
\section{Comparator}
Describe basic and advanced comparator

\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{chapters/4_DecodeStage/images/comparator_basic.pdf}
  \caption{Design of the basic comparator}
  \label{comparator_basic}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{chapters/4_DecodeStage/images/comparator_advanced.pdf}
  \caption{Design of the advanced comparator}
  \label{comparator_advanced}
\end{figure}

A further improvement has been done to the advanced comparator in order to manage comparison between both signed and unsigned numbers. 
...
\begin{table}[H]
  ...
  \end{tabular}
  \caption{All cases of possibile comparison}
